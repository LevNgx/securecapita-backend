...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRATION_TIME = 300000;//1_800_0000;
...
//        System.out.println(verifier.verify(token).getClaim(AUTHORITIES).isMissing());
    ...
    public Authentication getAuthentication(Long uerId, List<GrantedAuthority> authorities, HttpServletRequest request){
        UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = new UsernamePasswordAuthenticationToken(userService.getUserById(uerId), null, authorities);
